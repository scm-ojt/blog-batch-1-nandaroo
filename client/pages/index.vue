<template>
  <div class="d-flex mx-auto flex-column w-75 text-center">
    <div class="d-flex align-items-center mx-auto mb-3">
      ...
      <span class="fs-1 pl-2">Nuxt JS</span>
    </div>
    <div class="shadow sm:rounded-lg p-5 bg-white">
      ...
      <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
        ...
        >
        and start coding in
        <code class="bg-gray-100 text-sm p-1 rounded border">pages/index.vue</code>. Have
        fun!
      </p>
    </div>
    <div class="p-5">
